...
<!--                                    <div class="form-group col">
                                    ...
                                    <div class="input-group input-group-dynamic mt-3 col-4">

                                        <div class="multisteps-form__content">
                                            <div class="row mt-3">
                                                <div class="col-12">
                                                    <label class="form-control mb-0" for="photo_id">User profile photo</label>
                                                    <input  name="photos" type="file" class="form-control border dropzone dz-clickable"  multiple id="photos">
                                                </div>
                                            </div>
