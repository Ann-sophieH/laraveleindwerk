...
class PostPolicy
{
    use HandlesAuthorization;
        //autor can do everything here, we just check so we dont allow clients here
    /**
    ...
    public function delete(User $user, Post $post)
    {
        ...
        return $post->user_id === $user->id
            ? Response::allow()
            : Response::deny('You do not own this post, you cannot delete it.');
    ...
    public function restore(User $user, Post $post)
    {
        ...
        return $post->user_id === $user->id
            ? Response::allow()
            : Response::deny('You do not own this post, you cannot restore it.');
